(function () {
  ...
  function exportGedcom(data) {
    ...
    const lines = ["0 HEAD", "1 SOUR FAMILY_TREE_NOTE", "2 NAME 家系図ノート", "2 VERS 1.0.0-prototype.4-fix.4-kinship.2-fix.1", "1 GEDC", "2 VERS 5.5.1", "2 FORM LINEAGE-LINKED", "1 CHAR UTF-8", "1 LANG Japanese"];
